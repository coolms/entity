...
`coolms/entity` is a **platform package** -- it builds on `coolms/core` and only
...
`coolms/entity 2.0.0` does not assert that this package broke something; it
